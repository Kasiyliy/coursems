                                ...
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        ...
                                        <a href="{{route('course.details' ,['id'=>$course->id ])}}"
                                           class="btn-xs btn btn-info"><span class="fa fa-book"></span> Уроки</a>
                                        <form action="{{route('course.toggle.visible' ,['id'=>$course->id ])}}"
                                              method="post">
                                            {{csrf_field()}}
                                            <button type="submit" class="btn-xs btn btn-warning"><span
                                                        class="fa fa-eye"></span> {{$course->visible ? 'Скрыть' : 'Опубликовать'}}
                                            </button>
                                        </form>
                                    </td>
                                </tr>
